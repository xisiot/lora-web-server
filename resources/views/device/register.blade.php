...
@section('content')
    ...
    <div class="main-wrapper product-base main-height-wrapper">
        <div class="panel product-main">
            <div class="container">
                <ul class="pagination">
                    <li class="active"><a href="/device/register">OTAA注册模式</a></li>
                    <li><a href="/device/register/ABP">ABP注册模式</a></li>
                </ul>
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <h3 class="col-md-12 column" align="center">设备OTAA模式注册</h3>
                    </div>
                </div>
                @if (count($errors) > 0)
                ...
                @endif
                <div class="jumbotron well"><br>
                <form class="form form-horizontal " role="form" method="POST" action="{{ url('/device/register') }}">
                    {{ csrf_field() }}
                        @if($DevEUIFig==1)
                                <div class="field-wrapper form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" required="" validate="" maxlength=16 class="form-control " id="DevEUIInput" name="DevEUI"
                                               value="{{$DevEUIGet}}" placeholder="全球唯一辨识终端设备ID且须为8字节长" onblur="keypress1()"
                                               onkeyup="keypress1()" pattern="[0-9a-fA-F]{0,16}">
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/device/register/autoDevEUI" method="POST">
                    {!! csrf_field() !!}
...
<div class="modal fade AppKey-auto-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/device/register/autoAppKey" method="POST">
                    {!! csrf_field() !!}
...
<script>
    ...
    function keypress4() //DevEUI输入长度处理
    {
